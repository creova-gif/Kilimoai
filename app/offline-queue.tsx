    ...
    <View style={[s.root, { backgroundColor: colors.background }]}>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={s.header}>
          ...
          <TouchableOpacity
            ...
            style={[
              s.onlineBtn,
              {
                backgroundColor: online ? '#22d15a22' : '#ef444422',
                borderColor: online ? '#22d15a55' : '#ef444455',
              },
            ]}
          >
        ...
        >
          <LinearGradient
            colors={
              online ? ['#22d15a18', '#22d15a08'] : ['rgba(239,68,68,0.1)', 'rgba(239,68,68,0.04)']
            }
          ...
          >
            ...
            <View style={[s.storageBar, { backgroundColor: colors.border }]}>
              <View
                style={[
                  s.storageFill,
                  { width: '13%', backgroundColor: online ? '#22d15a' : '#ef4444' },
                ]}
              />
            </View>
          </LinearGradient>
                ...
                <View
                  style={[
                    s.qCard,
                    {
                      ...
                      borderColor: done ? '#22d15a44' : colors.border,
                      opacity: done ? 0.6 : 1,
                    },
                  ]}
                >
        ...
        >
          <TouchableOpacity
            ...
            style={[
              s.syncBtn,
              {
                backgroundColor: online ? '#22d15a' : colors.card,
                borderColor: online ? '#22d15a' : colors.border,
              },
            ]}
          >
