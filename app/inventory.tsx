...
const s = StyleSheet.create({
  ...
  summaryValue: { fontSize: 20, fontFamily: 'Inter_900Black', letterSpacing: -0.5 },
  summaryValueSm: { fontSize: 13, fontFamily: 'Inter_900Black', letterSpacing: -0.3 },
...
const ic = StyleSheet.create({
  ...
  catBadgeText: { fontSize: 8, fontFamily: 'Inter_900Black', letterSpacing: 0.8 },
  ...
  qtyText: { fontSize: 13, fontFamily: 'Inter_900Black', minWidth: 52, textAlign: 'center' },
