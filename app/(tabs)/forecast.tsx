...
const FORECAST_DAYS = [
  { day: 'Monday', date: 'Oct 12', high: 24, low: 16, condition: 'sun', pop: '0%', desc: 'Perfect for harvesting' },
  { day: 'Tuesday', date: 'Oct 13', high: 22, low: 15, condition: 'cloud', pop: '15%', desc: 'Optimal planting' },
  { day: 'Wednesday', date: 'Oct 14', high: 19, low: 14, condition: 'rain', pop: '85%', desc: 'Heavy rain expected' },
  { day: 'Thursday', date: 'Oct 15', high: 21, low: 15, condition: 'storm', pop: '60%', desc: 'Potential wind risks' },
  { day: 'Friday', date: 'Oct 16', high: 25, low: 17, condition: 'sun', pop: '0%', desc: 'Excellent soil drying' },
  { day: 'Saturday', date: 'Oct 17', high: 23, low: 16, condition: 'cloud', pop: '10%', desc: 'Mild and overcast' },
  { day: 'Sunday', date: 'Oct 18', high: 20, low: 15, condition: 'rain', pop: '90%', desc: 'Irrigation not required' },
];
        ...
        >
          ...
          >
            ...
            <motion.View variants={itemVariants} style={styles.header}>
              <View>
                <View style={[styles.statusBadge, { backgroundColor: colors.primary + '15' }]}>
                  ...
                  <Text style={[styles.statusText, { color: colors.primary }]}>CLIMATE ANALYTICS</Text>
                </View>
                <Text style={[styles.headerTitle, { color: colors.text }]}>Regional Outlook</Text>
              ...
              <BlurView intensity={isDark ? 30 : 80} tint={isDark ? "dark" : "light"} style={[styles.mainCard, { borderColor: colors.border }]}>
                ...
                <View style={styles.heroTop}>
                  <View style={styles.tempSection}>
                    <Text style={[styles.todayText, { color: colors.textMute }]}>TODAY, 12 OCT</Text>
                    ...
                    <Text style={[styles.conditionMain, { color: colors.text }]}>Partly Cloudy</Text>
                  </View>
                  <motion.View 
                    animate={{ 
                      y: [0, -10, 0],
                ...
                <View style={styles.statsGrid}>
                  <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statLabel, { color: colors.textMute }]}>Humidity</Text>
                  </View>
                  <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statLabel, { color: colors.textMute }]}>Wind</Text>
                  </View>
                  <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statLabel, { color: colors.textMute }]}>Feels Like</Text>
                  </View>
                </View>
              </BlurView>
            </motion.View>
            ...
            <motion.View variants={itemVariants}>
              <BlurView intensity={isDark ? 10 : 30} tint={isDark ? "dark" : "light"} style={[styles.insightCard, { borderColor: colors.primary + '30' }]}>
                <View style={styles.insightHeader}>
                  ...
                  <Text style={[styles.insightTitle, { color: colors.primary }]}>AI CROP RECOMMENDATION</Text>
                </View>
                <Text style={[styles.insightText, { color: colors.text }]}>
                  Incoming precipitation in 48h. Postpone fertilization of maize in Block B to avoid nutrient runoff.
                </Text>
              </BlurView>
            </motion.View>
            ...
            <motion.View variants={itemVariants} style={styles.sectionHeader}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Weekly Forecast</Text>
              <TouchableOpacity style={styles.moreButton}>
                <Text style={[styles.moreText, { color: colors.primary }]}>DETAILS</Text>
              </TouchableOpacity>
            </motion.View>
