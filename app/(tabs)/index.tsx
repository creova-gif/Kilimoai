        ...
        {records.map((item: any, idx: number) => {
          ...
          return (
            <TouchableOpacity
              ...
              accessibilityLabel={
                language === 'sw'
                  ? `${item.title}, ${item.subtitle}, ${isCompleted ? 'Imekamilika' : isNext ? 'Inayofuata' : 'Inasubiri'}`
                  : `${item.title}, ${item.subtitle}, ${isCompleted ? 'Completed' : isNext ? 'Next' : 'Pending'}`
              }
            >
              {/* Connector line */}
              ...
              >
                {isCompleted ? (
                  ...
                  <View
                    style={{ width: 5, height: 5, borderRadius: 3, backgroundColor: '#f59e0b' }}
                  />
                ) : null}
              </View>
              ...
              <Text
                style={[styles.stepMainTitle, { color: isDark ? '#fff' : colors.text }]}
                numberOfLines={1}
              >
                {item.title}
              </Text>
        ...
        <View style={styles.cropValueFooter}>
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor: isDark ? 'rgba(34,209,90,0.12)' : colors.primaryLight,
      ...
      >
        ...
        <View style={styles.organizerHeader}>
          ...
          <View
            style={[
              ...
              {
                backgroundColor: pendingTotal > 0 ? 'rgba(239,68,68,0.12)' : 'rgba(34,209,90,0.1)',
                borderColor: pendingTotal > 0 ? 'rgba(239,68,68,0.25)' : 'rgba(34,209,90,0.2)',
              },
            ]}
          >
            <Text
              style={[
                ...
                { color: pendingTotal > 0 ? '#ef4444' : '#22d15a' },
              ]}
            >
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            { backgroundColor: isDark ? 'rgba(34,209,90,0.1)' : colors.primaryLight },
          ]}
        >
          ...
          >
            ...
            >
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                ...
                <View>
                  ...
                  >
                    <View
                      style={{ width: 5, height: 5, borderRadius: 2.5, backgroundColor: '#22d15a' }}
                    />
                    <Text
                      style={{
                        fontSize: 9,
            ...
            {isOffline && (
              ...
              >
                ...
                <Text style={{ color: '#fff', fontSize: 11, fontWeight: 'bold', marginLeft: 4 }}>
                        ...
                        return (
                          <View
                            ...
                            style={{
                              ...
                              height: 4,
                              borderRadius: 2,
                              backgroundColor: filled ? '#22d15a' : 'rgba(255,255,255,0.15)',
                            }}
                          />
                        );
                      })}
            ...
            >
              {quickActions.map((action) => (
                ...
                >
                  ...
                  >
                    <View style={styles.actionIconOuter}>{action.icon}</View>
                    <View>
