    ...
    <Animated.View entering={FadeInDown} style={[styles.bentoMain, { borderColor: colors.border }]}>
      ...
      <View style={styles.bentoFooter}>
        <TouchableOpacity
          ...
          accessibilityLabel="Angalia ramani ya masoko na pembejeo"
        >
    ...
    <Modal visible={visible} transparent animationType="slide" presentationStyle="overFullScreen">
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1, justifyContent: 'flex-end' }}>
        <View style={[pm.sheet, { backgroundColor: colors.card, borderTopColor: colors.border, borderTopWidth: 1 }]}>
          ...
          <View style={pm.row}>
            <Text style={[pm.title, { color: colors.text }]}>Arifa za Bei</Text>
            <TouchableOpacity
              onPress={onClose}
              style={[pm.closeBtn, { backgroundColor: colors.background }]}
              accessibilityRole="button"
              accessibilityLabel="Close price alerts modal"
            >
          ...
          {adding ? (
            <View style={{ gap: 12, marginTop: 8 }}>
              ...
              <View style={{ flexDirection: 'row', gap: 10 }}>
                {(['above', 'below'] as const).map((d) => (
                  <TouchableOpacity
                    ...
                    style={{ flex: 1 }}
                    accessibilityRole="button"
                    accessibilityLabel={d === 'above' ? 'Alert if price goes above threshold' : 'Alert if price goes below threshold'}
              ...
              <View style={[pm.inputWrap, { borderColor: colors.border, backgroundColor: colors.background }]}>
                <TextInput
                  ...
                  accessibilityHint="Enter the price threshold in TZS"
                />
              </View>
              <View style={{ flexDirection: 'row', gap: 10 }}>
                <TouchableOpacity
                ...
                >
                  <Text style={{ color: colors.textMute, fontFamily: 'Inter_700Bold' }}>Ghairi</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={save}
                ...
                >
                  ...
                  <Text style={{ color: isDark ? '#000' : '#fff', fontFamily: 'Inter_900Black' }}>Hifadhi Arifa</Text>
                </TouchableOpacity>
              </View>
            </View>
          ) : (
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityLabel="Add new price alert"
            >
              <Plus size={18} color={isDark ? '#000' : '#fff'} />
              <Text style={{ color: isDark ? '#000' : '#fff', fontFamily: 'Inter_900Black' }}>Ongeza Arifa Mpya</Text>
            </TouchableOpacity>
          )}
        ...
        <View style={[pm.sheet, { backgroundColor: colors.card, borderTopColor: colors.border, borderTopWidth: 1 }]}>
          ...
          <View style={pm.row}>
            ...
            <TouchableOpacity
              ...
              style={[pm.closeBtn, { backgroundColor: colors.background }]}
              accessibilityRole="button"
              accessibilityLabel="Close make offer modal"
            >
              <X size={16} color={colors.textMute} />
            </TouchableOpacity>
          </View>
          <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            <View style={[pm.inputWrap, { borderColor: colors.border, backgroundColor: colors.background }]}>
              <TextInput
                ...
                accessibilityHint="Enter quantity needed"
              />
            </View>
            ...
            <View style={[pm.inputWrap, { borderColor: colors.border, backgroundColor: colors.background }]}>
              <TextInput
                ...
                accessibilityLabel="Offer price per bag"
                accessibilityHint="Enter your offered price in TZS"
              />
            </View>
            ...
            <View style={[pm.inputWrap, { borderColor: colors.border, backgroundColor: colors.background, height: 80 }]}>
              <TextInput
                ...
                style={[pm.input, { color: colors.text }]}
                placeholderTextColor={colors.textMute}
                placeholder="Jina lako, mahali pa uwasilishaji, maelezo..."
                accessibilityLabel="Optional message"
                accessibilityHint="Enter any instructions or questions for the seller"
              />
            </View>
            {total > 0 && (
            ...
            >
              <Send size={16} color={isDark ? '#000' : '#fff'} />
              <Text style={{ color: isDark ? '#000' : '#fff', fontFamily: 'Inter_900Black', fontSize: 15 }}>Tuma Ofa</Text>
            </TouchableOpacity>
        ...
        <View style={[pm.sheet, { backgroundColor: colors.card, borderTopColor: colors.border, borderTopWidth: 1 }]}>
          ...
          <View style={pm.row}>
            ...
            <TouchableOpacity
              ...
              style={[pm.closeBtn, { backgroundColor: colors.background }]}
              accessibilityRole="button"
              accessibilityLabel="Close sell listing modal"
            >
              <X size={16} color={colors.textMute} />
            </TouchableOpacity>
          </View>
          <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={[pm.inputWrap, { borderColor: colors.border, backgroundColor: colors.background }]}>
                  <TextInput
                    ...
                    placeholder="500"
                    accessibilityLabel="Quantity in kilograms"
                    accessibilityHint="Enter quantity to sell"
                  />
                </View>
              </View>
              <View style={{ flex: 1 }}>
                ...
                <View style={[pm.inputWrap, { borderColor: colors.border, backgroundColor: colors.background }]}>
                  <TextInput
                    ...
                    accessibilityHint="Enter price per kilogram in TZS"
                  />
                </View>
              </View>
            </View>
            ...
            <View style={{ gap: 8 }}>
              {GRADES.map((g) => (
                <TouchableOpacity
                  key={g}
                  onPress={() => { setGrade(g); Haptics.selectionAsync(); }}
                  style={[pm.gradeRow, { borderColor: grade === g ? colors.success : colors.border, backgroundColor: grade === g ? colors.success + '10' : 'transparent' }]}
                  accessibilityRole="button"
                  accessibilityLabel={g}
                  accessibilityState={{ checked: grade === g }}
                >
                  <View style={[pm.gradeRadio, { borderColor: grade === g ? colors.success : colors.border }]}>
                    {grade === g && <View style={[pm.gradeInner, { backgroundColor: colors.success }]} />}
                  </View>
                  <Text style={{ fontFamily: 'Inter_700Bold', fontSize: 13, color: grade === g ? colors.success : colors.text }}>{g}</Text>
                </TouchableOpacity>
              ))}
            </View>
            ...
            <View style={[pm.inputWrap, { borderColor: colors.border, backgroundColor: colors.background, height: 72 }]}>
              <TextInput
                ...
                style={[pm.input, { color: colors.text }]}
                placeholderTextColor={colors.textMute}
                placeholder="Hali ya mazao, usafirishaji, mawasiliano..."
                accessibilityLabel="Additional notes"
                accessibilityHint="Enter details about crop condition or delivery options"
              />
            </View>
            ...
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityLabel="Publish listing to marketplace"
            >
              <Globe size={16} color={isDark ? '#000' : '#fff'} />
              <Text style={{ color: isDark ? '#000' : '#fff', fontFamily: 'Inter_900Black', fontSize: 15 }}>Chapisha Tangazo</Text>
            </TouchableOpacity>
            <View style={{ height: 32 }} />
          </ScrollView>
        </View>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <Animated.View style={[styles.searchContainer, searchFocused && styles.searchContainerFocused]}>
            <BlurView intensity={isDark ? 25 : 75} tint={isDark ? 'dark' : 'light'} style={[styles.searchBar, { borderColor: searchFocused ? colors.primary : colors.border }]}>
              ...
              <TextInput
                placeholder="Tafuta bidhaa, masoko, mikoa..."
                placeholderTextColor={colors.textMute}
                ...
                accessibilityLabel="Search products, markets, or regions"
                accessibilityHint="Filter market items by typing"
              />
              <View style={styles.searchActions}>
                {searchQuery.length > 0 ? (
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => { Haptics.selectionAsync(); Alert.alert('Chuja (Filter)', 'Pangilia kwa:', [{ text: 'Bei: Juu → Chini', onPress: () => {} }, { text: 'Bei: Chini → Juu', onPress: () => {} }, { text: 'Hifadhi ya Karibu', onPress: () => {} }, { text: 'Ghairi', style: 'cancel' }]); }}
                    accessibilityRole="button"
                    accessibilityLabel="Filter results"
                    accessibilityHint="Open sorting and filtering dialog"
                  >
          ...
          <View style={styles.stickyCategory}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.categoryContent}>
              {CATEGORIES.map((cat, idx) => (
                <Animated.View key={cat.name} entering={FadeInDown}>
                  <TouchableOpacity
                    onPress={() => { setActiveCategory(cat.name); Haptics.selectionAsync(); }}
                    accessibilityRole="button"
              ...
              return (
                <Animated.View key={item.id} entering={FadeInDown}>
                  <TouchableOpacity
                    ...
                    activeOpacity={0.9}
                    accessibilityRole="button"
                    accessibilityLabel={`${item.emoji} ${item.name} at ${item.market}. Price is TZS ${fmt(item.priceNum)} per ${item.unit}. Click to expand.`}
                  ...
                  >
                    <BlurView intensity={isDark ? 20 : 60} tint={isDark ? 'dark' : 'light'}
                      ...
                      <View style={styles.cardHeader}>
                        ...
                        <View style={[styles.volatilityBadge, { backgroundColor: item.volatility === 'High' ? colors.error + '15' : colors.success + '15' }]}>
                          <Text style={[styles.volatilityText, { color: item.volatility === 'High' ? colors.error : colors.success }]}>{item.volatility}</Text>
                        </View>
                      </View>
                      <View style={styles.cardBody}>
                        ...
                        <View style={styles.trendArea}>
                          ...
                          <View style={[styles.trendPill, { backgroundColor: item.positive ? colors.success + '20' : colors.error + '20' }]}>
                            {item.positive ? <TrendingUp size={12}  /> : <TrendingDown size={12} color={colors.error} />}
                        ...
                        {isExpanded && (
                          <Animated.View entering={FadeInDown} exiting={FadeOut} style={styles.expandedContent}>
                            ...
                            <View style={styles.actionGrid}>
                              <TouchableOpacity
                                ...
                                accessibilityRole="button"
                                accessibilityLabel={`Make offer on ${item.name}`}
                              >
        ...
        <Animated.View entering={FadeInDown} style={styles.fab}>
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            accessibilityRole="button"
            accessibilityLabel="Create listing to sell crops"
          >
