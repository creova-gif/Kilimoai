  ...
  return (
    <View style={[s.root, { backgroundColor: colors.background }]}>
      ...
      <View
        style={[
          s.orb1,
          { backgroundColor: isDark ? 'rgba(34,209,90,0.1)' : 'rgba(34,209,90,0.05)' },
        ]}
      />
      <View
        style={[
        ...
        <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
          ...
          <Animated.View entering={FadeInDown.springify()}>
            <LinearGradient
              ...
              style={[
                s.hero,
                { borderColor: isDark ? 'rgba(34,209,90,0.25)' : 'rgba(34,209,90,0.15)' },
              ]}
            >
              <View style={s.heroLeft}>
                <View
                  style={[
                    s.heroBadge,
                    { backgroundColor: isDark ? 'rgba(34,209,90,0.3)' : 'rgba(34,209,90,0.1)' },
                  ]}
                >
          ...
          <View style={s.pinnedGrid}>
            {pinnedItems.map((item, i) => (
              <Animated.View key={item.feature} entering={FadeInDown.delay(i * 60).springify()}>
