              ...
              <View style={s.plRow}>
                ...
                <View style={s.plItem}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                    {profit >= 0 ? (
                      <TrendingUp size={14} color="#22d15a" />
                    ) : (
                      <TrendingDown size={14} color="#ef4444" />
                    )}
                    <Text style={[s.plValue, { color: profit >= 0 ? '#22d15a' : '#ef4444' }]}>
                        ...
                        <View style={[s.catTrack, { backgroundColor: colors.background }]}>
                          <View
                            style={[
                              ...
                              {
                                width: `${pct * 100}%`,
                                backgroundColor: val >= 0 ? '#22d15a' : '#ef4444',
                              },
                            ]}
                          />
                        </View>
              ...
              return (
                <Animated.View key={e.id} entering={FadeInDown.delay(i * 40).springify()}>
                  ...
                  >
                    ...
                    <Text
                      style={[s.entryAmt, { color: e.type === 'income' ? '#22d15a' : '#ef4444' }]}
                    >
                      {e.type === 'income' ? '+' : '-'}
                      {fmtTZS(e.amount)}
                    </Text>
