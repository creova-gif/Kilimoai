...
const CROP_DATA: Record<Season, CropRec[]> = {
  ...
  kiangazi: [
    ...
    { id: 'k4', name: 'Sorghum', nameSw: 'Mtama', emoji: '🌿', daysToHarvest: 90, yieldPerAcre: '1.5 tani', price: 'TZS 55,000/mfuko', water: 'Chini', risk: 'Chini', color: '#84cc16', plantWeeks: 1, growWeeks: 10, harvestWeeks: 2, tips: ['Ustahimili ukame zaidi ya mahindi', 'Inafaa kwa maeneo ya Dodoma/Singida', 'Tumia kwa chakula na lishe ya wanyama'] },
  ],
};
