        ...
        >
          ...
          <motion.View variants={itemVariants} style={styles.header}>
            ...
            <View style={styles.headerCenter}>
              <View style={[styles.spatialBadge, { backgroundColor: colors.primary + '30' }]}>
                ...
                <Text style={[styles.spatialText, { color: colors.primary }]}>SPATIAL INTEL v4.1</Text>
              </View>
              <BlurView intensity={25} tint="dark" style={styles.searchContainer}>
                ...
                <Text style={styles.searchPlaceholder}>Analyze Plot Coordinates...</Text>
              </BlurView>
            </View>
          ...
          >
            ...
            <BlurView intensity={20} tint="dark" style={styles.pinLabel}>
              <Text style={styles.pinText}>Neural Node 01</Text>
            </BlurView>
          </motion.View>

          {/* Field Analysis Bottom Sheet */}
          <motion.View 
            initial={{ y: 300 }}
            animate={{ y: 0 }}
          ...
          >
            <BlurView intensity={90} tint={isDark ? "dark" : "light"} style={[styles.sheetContent, { borderColor: colors.border }]}>
              ...
              <View style={styles.sheetHeader}>
                <View>
                  <Text style={[styles.sheetTitle, { color: colors.text }]}>Maize Field Alpha</Text>
                  <View style={styles.metaRow}>
                    <Navigation size={12} color={colors.primary} style={{ marginRight: 6 }} />
                    <Text style={[styles.metaText, { color: colors.textMute }]}>Sector 7G • 2.4 Hectares • Optimal Health</Text>
                  </View>
                </View>
                <TouchableOpacity style={[styles.addPlotBtn, { backgroundColor: colors.primary }]} onPress={handleAction}>
                  <Plus size={20} color="#000" />
                  <Text style={styles.addPlotText}>Add Sub-Plot</Text>
                </TouchableOpacity>
              </View>
              
              <View style={[styles.statsGrid, { backgroundColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.03)' }]}>
                <View style={styles.statItem}>
                  <Text style={[styles.statLabel, { color: colors.textMute }]}>SOIL MOISTURE</Text>
                  <Text style={[styles.statValue, { color: colors.text }]}>18.4%</Text>
                </View>
                <View style={[styles.divider, { backgroundColor: colors.border }]} />
                <View style={styles.statItem}>
                  <Text style={[styles.statLabel, { color: colors.textMute }]}>NDVI INDEX</Text>
                  <Text style={[styles.statValue, { color: colors.text }]}>0.82</Text>
                </View>
                <View style={[styles.divider, { backgroundColor: colors.border }]} />
                <View style={styles.statItem}>
                  <Text style={[styles.statLabel, { color: colors.textMute }]}>PROJECTED YIELD</Text>
              ...
              <TouchableOpacity style={styles.fullAnalysisBtn} onPress={handleAction}>
                ...
                <Text style={[styles.fullAnalysisText, { color: colors.primary }]}>Initialize Full Biomass Scan</Text>
              </TouchableOpacity>
            </BlurView>
          </motion.View>
        </motion.View>
