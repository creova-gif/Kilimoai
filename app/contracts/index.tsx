        ...
        <View style={[cm.sheet, { backgroundColor: isDark ? '#0d1a0f' : '#fff' }]}>
          ...
          >
            ...
            {contractValue > 0 && (
              <Animated.View
                entering={FadeInDown}
                style={[cm.valueBar, { backgroundColor: '#22d15a15', borderColor: '#22d15a30' }]}
              >
                <Text style={[cm.valueBarLabel, { color: colors.textMute }]}>
                  Thamani ya mkataba
                </Text>
                <Text style={[cm.valueBarAmount, { color: '#22d15a' }]}>
              ...
              {CROPS.map((c) => (
                <TouchableOpacity
                  ...
                  style={[
                    cm.chip,
                    {
                      borderColor: crop === c ? '#22d15a' : colors.border,
                      backgroundColor: crop === c ? '#22d15a20' : 'transparent',
                    },
                  ]}
                >
                  <Text style={[cm.chipText, { color: crop === c ? '#22d15a' : colors.textMute }]}>
                    {c}
                  </Text>
                </TouchableOpacity>
              ))}
              ...
              {REGIONS.map((r) => (
                <TouchableOpacity
                  ...
                  style={[
                    cm.chip,
                    {
                      borderColor: region === r ? '#22d15a' : colors.border,
                      backgroundColor: region === r ? '#22d15a20' : 'transparent',
                    },
                  ]}
                >
                  <Text
                    style={[cm.chipText, { color: region === r ? '#22d15a' : colors.textMute }]}
                  >
                    {r}
                  </Text>
                </TouchableOpacity>
