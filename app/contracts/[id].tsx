          ...
          <View style={[S.panel, { backgroundColor: colors.background }]}>
            ...
            <Animated.View entering={FadeInDown.delay(60).springify()}>
              ...
              >
                ...
                <View
                  style={[S.cropBadge, { backgroundColor: '#22d15a18', borderColor: '#22d15a35' }]}
                >
                      ...
                      <View style={S.timelineConnRow}>
                        ...
                        {i < contract.milestones.length - 1 && (
                          <View
                            style={[
                              S.tlLine,
                              { backgroundColor: m.paid ? '#22d15a' : colors.border },
                            ]}
                          />
                        )}
                      </View>
                    ...
                    >
                      ...
                      {!m.paid ? (
                        <TouchableOpacity
                          ...
                          style={[
                            S.payBtn,
                            { backgroundColor: '#22d15a18', borderColor: '#22d15a50' },
                          ]}
                        >
