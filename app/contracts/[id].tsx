...
const s = StyleSheet.create({
  ...
  statusText: { fontSize: 11, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: 1.2 },
  heroValue: { fontSize: 32, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: -1 },
  ...
  actionText: { fontSize: 13, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: 0.3 },
