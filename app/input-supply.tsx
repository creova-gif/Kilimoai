...
const s = StyleSheet.create({
  ...
  supName: { fontSize: 15, fontFamily: 'InstrumentSerif_400Regular', flex: 1 },
  vetBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  vetText: { fontSize: 8, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: 0.5 },
  ...
  orderText: { fontSize: 12, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: 0.3 },
  ...
  orderStatusText: { fontSize: 10, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: 0.5 },
  confirmBtn: { marginTop: 10, paddingVertical: 8, borderRadius: 10, alignItems: 'center' },
  confirmText: { fontSize: 12, fontFamily: 'InstrumentSerif_400Regular' },
});
