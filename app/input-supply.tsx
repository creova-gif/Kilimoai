        ...
        return (
          <React.Fragment key={i}>
            <View style={tl.step}>
              ...
              <Text
                style={[tl.label, { color: done || active ? '#22d15a' : '#475569' }]}
                numberOfLines={1}
              >
                {label}
              </Text>
            ...
            {i < 2 && (
              <View
                style={[tl.line, { backgroundColor: i < current - 1 ? '#22d15a' : '#1e293b' }]}
              />
            )}
          </React.Fragment>
        );
                  ...
                  {CAT_FILTERS.map((f) => {
                    ...
                    return (
                      ...
                      >
                        {f.icon}
                        <Text
                          style={[s.filterText, { color: active ? '#22d15a' : colors.textMute }]}
                        >
                          {f.label}
                        </Text>
                      </TouchableOpacity>
