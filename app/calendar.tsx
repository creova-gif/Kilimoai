                  ...
                  <View style={styles.dotRow}>
                    {dots.map((t, di) => (
                      <View
                        ...
                        style={[
                          styles.taskDot,
                          { backgroundColor: PRIORITY_COLOR[t.priority] || '#22d15a' },
                        ]}
                      />
                    ))}
                  </View>
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.dayHeader}>
          ...
          <TouchableOpacity
            ...
            style={[
              styles.addDayBtn,
              { backgroundColor: 'rgba(34,209,90,0.12)', borderColor: 'rgba(34,209,90,0.25)' },
            ]}
          >
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          ...
          >
                ...
                {CATEGORIES.map((c) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          newCategory === c.id ? 'rgba(34,209,90,0.15)' : 'transparent',
                        borderColor:
                          newCategory === c.id
                            ? '#22d15a'
                            : isDark
                  ...
                  >
                    <CatIcon
                      cat={c.id}
                      size={14}
                      color={newCategory === c.id ? '#22d15a' : colors.textMute}
                    />
                    <Text
                      style={[
                        styles.catBtnText,
            ...
            <TouchableOpacity
              ...
              style={[
                styles.aiHint,
                { backgroundColor: 'rgba(34,209,90,0.07)', borderColor: 'rgba(34,209,90,0.2)' },
              ]}
            >
            ...
            <View style={styles.modalActions}>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.saveBtn,
                  { backgroundColor: newTitle.trim() ? '#22d15a' : colors.textMute + '40' },
                ]}
              >
                {saving ? (
    ...
    >
      <View style={styles.aiOverlay}>
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          ...
          >
            <LinearGradient
              colors={['rgba(34,209,90,0.1)', 'rgba(34,209,90,0.03)', 'transparent']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
              style={StyleSheet.absoluteFill}
              pointerEvents="none"
            ...
            <View style={styles.aiHeader}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                ...
                <View
                  style={[
                    styles.aiLiveDot,
                    { backgroundColor: 'rgba(34,209,90,0.15)', borderColor: 'rgba(34,209,90,0.3)' },
                  ]}
                >
                  <View
                    style={{ width: 5, height: 5, borderRadius: 3, backgroundColor: '#22d15a' }}
                  />
                  <Text style={{ fontSize: 8, fontFamily: 'Inter_700Bold', color: '#22d15a' }}>
                    LIVE
                  </Text>
                </View>
              </View>
            ...
            >
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.aiSendBtn,
                  { backgroundColor: aiInput.trim() ? '#22d15a' : 'transparent' },
                ]}
              >
                {aiLoading ? (
                  <ActivityIndicator size="small" color="#22d15a" />
