...
const s = StyleSheet.create({
  ...
  groupName: { fontSize: 16, fontFamily: 'InstrumentSerif_400Regular' },
  groupMeta: { fontSize: 13, fontFamily: 'Inter_500Medium', marginTop: 2 },
  ...
  joinText: { fontSize: 14, fontFamily: 'Inter_600SemiBold' },
