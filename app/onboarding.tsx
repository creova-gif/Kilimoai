...
const FEATURES = [
  {
    icon: <Sparkles size={20} color="#22d15a" />,
    bg: 'rgba(34, 209, 90, 0.12)',
    label: 'Sankofa AI',
    sub: 'Ushauri wa AI',
  },
  {
    icon: <Leaf size={20} color="#22d15a" />,
    bg: 'rgba(34, 209, 90, 0.12)',
    label: 'Crop Scan',
    sub: 'Tambua magonjwa',
  },
...
function DoneStep({ t, name, role, lang }: any) {
  ...
  return (
    ...
    >
      ...
      <LinearGradient
        colors={
          isDark ? ['rgba(34, 209, 90, 0.12)', 'rgba(34, 209, 90, 0.03)'] : ['#F0FAF2', '#FFFFFF']
        }
...
function createStyles(colors: ReturnType<typeof useTheme>['colors'], isDark: boolean) {
  return StyleSheet.create({
    ...
    langDivider: {
      width: 40,
      height: 1.5,
      backgroundColor: 'rgba(34, 209, 90, 0.3)',
      marginVertical: 28,
    },
    langPick: {
      color: colors.textMute,
