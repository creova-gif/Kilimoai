...
const s = StyleSheet.create({
  ...
  product: { fontSize: 15, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: -0.3 },
  ...
  enrollText: { color: '#000', fontSize: 13, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: 0.5 },
  ...
  claimBtnText: { fontSize: 12, fontFamily: 'InstrumentSerif_400Regular', letterSpacing: 0.3 },
});
