                ...
                <View style={{ gap: 16 }}>
                  ...
                  <View style={[s.pnlBox, { borderColor: colors.border }]}>
                    ...
                    <View style={s.pnlRow}>
                      ...
                      <Text
                        style={{ fontSize: 13, fontFamily: 'Inter_800ExtraBold', color: '#22d15a' }}
                      >
                ...
                <View style={{ gap: 16 }}>
                  ...
                  <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text
                        style={{ fontSize: 12, color: colors.textMute, marginTop: 1 }}
                        numberOfLines={2}
                      >
...
function Spec({ label, value, highlight }: any) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Text style={[s.specValue, { color: highlight ? '#22d15a' : colors.text }]} numberOfLines={1}>
        {value}
      </Text>
    </View>
  );
