        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-[#2E7D32] transition-colors z-10" />
                <Input
                  id="name"
                  placeholder="Enter your full name"
                  value={formData.name}
                  onChange={(e) => setFormData(prev => ({ ...prev, name: e.target.value }))}
                  className="pl-12 h-12 border border-gray-300 rounded-xl focus:border-[#2E7D32]/20 focus:ring-2 focus:ring-[#2E7D32]/30/20 transition-all bg-white"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-[#2E7D32] transition-colors z-10" />
                <Input
                  id="phone"
                  type="tel"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-[#2E7D32] transition-colors z-10" />
                <Input
                  id="email"
                  type="email"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-[#2E7D32] transition-colors z-10" />
                <Input
                  id="password"
                  type="password"
          ...
          <div className="space-y-4 pt-2">
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="userType" className="h-12 border border-gray-300 rounded-xl focus:border-[#2E7D32]/20 focus:ring-2 focus:ring-[#2E7D32]/30/20 bg-white">
                ...
                <SelectContent>
                  <SelectItem value="farmer" className="py-3">
                    <div className="flex items-center justify-between w-full gap-3">
                      ...
                      <span className="px-2 py-0.5 bg-[#2E7D32]/10 text-[#2E7D32] text-xs font-bold rounded-full whitespace-nowrap">FREE</span>
                    </div>
                  </SelectItem>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-[#2E7D32] transition-colors z-10 pointer-events-none" />
                <Select
                  value={formData.region}
                  onValueChange={(value) => setFormData(prev => ({ ...prev, region: value }))}
                >
                  <SelectTrigger id="region" className="h-12 pl-12 border border-gray-300 rounded-xl focus:border-[#2E7D32]/20 focus:ring-2 focus:ring-[#2E7D32]/30/20 bg-white">
            ...
            <div className="space-y-5 pt-2">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-16 px-4 text-center text-2xl font-bold border border-gray-300 bg-white focus:border-[#2E7D32]/20 focus:ring-2 focus:ring-[#2E7D32]/30/20 rounded-2xl transition-all"
                  />
                </div>
              ...
              <div className="pt-1">
                <button
                  ...
                  className="text-sm text-[#2E7D32] hover:text-[#2E7D32] font-medium flex items-center gap-2 transition-colors group"
                >
                        ...
                        <button
                          ...
                          className={`h-14 rounded-xl border-2 transition-all font-medium text-sm ${
                            formData.gender === 'female'
                              ? 'border-[#2E7D32]/20 bg-[#2E7D32]/5 text-[#2E7D32] shadow-sm'
                              : 'border-gray-200 bg-white text-gray-700 hover:border-[#2E7D32]/20 hover:bg-[#2E7D32]/5/50'
                          }`}
                        >
                          Female
                        </button>
          ...
          <div className="space-y-3 pt-4">
            <Button 
              type="submit" 
              className="w-full bg-gradient-to-r from-[#2E7D32] via-[#2E7D32] to-gray-100 hover:from-[#2E7D32] hover:via-[#2E7D32] hover:to-gray-100 h-14 shadow-lg hover:shadow-xl text-base font-bold rounded-xl transition-all transform hover:scale-[1.01] active:scale-[0.99]"
              disabled={loading}
            >
              {loading ? (
