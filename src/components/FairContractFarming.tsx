...
export function FairContractFarming({ userId, language }: FairContractFarmingProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50/10 pb-6">
      {/* Header */}
      <div className="bg-gradient-to-br from-green-600 via-emerald-600 to-green-700 text-white px-4 lg:px-6 py-6">
              ...
              {expandedSection === "protections" && (
                <div className="px-6 pb-6 space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg p-5 border-2 border-purple-200">
                    <div className="flex items-start gap-4">
                      <div className="h-12 w-12 bg-purple-600 text-white rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        {contract.riskFlags.map((flag, idx) => (
                          <div key={idx} className={`p-4 rounded-lg border ${
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <p className={`text-sm ${
                                flag.type === "warning" ? "text-amber-800" : "text-blue-800"
                              }`}>
                                {flag.message}
                              </p>
                            </div>
            ...
            {activeTab === "available" && (
              <div className="space-y-6">
                {availableContracts.map((contract) => (
                  <div key={contract.id} className="bg-white rounded-xl shadow-sm border-2 border-purple-200 p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <div className="h-16 w-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl">
                          {contract.buyer!.name.charAt(0)}
